  ...
  document.querySelectorAll('pre').forEach(function(pre) {
    ...
    copyBtn.innerHTML = `
      <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
        <path d="M19 21H9a2 2 0 0 1-2-2V7h2v12h10ZM16 3h-2.586l-.707-.707A.997.997 0 0 0 12.586 2H8a2 2 0 0 0-2 2v14h2V4h4v1h4a2 2 0 0 1 2 2v10h2V7a4 4 0 0 0-4-4Z" />
      </svg>
    `;
